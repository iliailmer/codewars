...
They both start at the same spot called "Start" and they each run a different
lap, which may (or may not) vary in length.
...
finds the number of laps that each jogger has to complete before they
