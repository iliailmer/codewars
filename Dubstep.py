...
Recently, he has decided to take a couple of old songs and
...
Polycarpus inserts a certain number of words "WUB" before
the first word of the song (the number may be zero),
...
consisting only of uppercase English letters, the string's length doesn't
