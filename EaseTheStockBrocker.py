...
Quantity is an int, Price a double (with mandatory decimal point "." ),
...
A multiple order is the concatenation of simple orders with a
comma between each.
...
(rounded to integers), b representing the total price of bought stocks and
s the total price of sold stocks.
...
b representing the total price of bought stocks with correct
simple order and s the total price of sold stocks with correct simple order.
...
Note: Due to Codewars whitespace differences will not
always show up in test results.
"""
